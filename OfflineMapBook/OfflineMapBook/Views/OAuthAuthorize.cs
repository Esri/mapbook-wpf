...
namespace OfflineMapBook.Views
{
    ...
    public class OAuthAuthorize : IOAuthAuthorizeHandler
    {
        ...
        public Task<IDictionary<string, string>> AuthorizeAsync(Uri serviceUri, Uri authorizeUri, Uri callbackUri)
        {
            ...
            if (this.taskCompletionSource != null || this.window != null)
            {
            ...
            this.authorizeUrl = authorizeUri.AbsoluteUri;
            ...
            {
                this.AuthorizeOnUIThread(this.authorizeUrl);
            }
            else
            {
                dispatcher.BeginInvoke((Action)(() => this.AuthorizeOnUIThread(this.authorizeUrl)));
            }
        ...
        {
            if (this.window != null && this.window.Owner != null)
            {
            ...
            if (this.taskCompletionSource != null && !this.taskCompletionSource.Task.IsCompleted)
            {
                ...
                this.taskCompletionSource.SetException(new OperationCanceledException());
            }
        ...
        private void WebBrowserOnNavigating(object sender, NavigatingCancelEventArgs e)
        {
            ...
            if (isRedirected)
            {
                ...
                this.taskCompletionSource.SetResult(authResponse);
